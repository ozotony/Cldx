<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_details4cc.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_details4cc" %>
    ...
    <body>
       ...
       <tr>
        ...
        <tr>
           ...
           <asp:Panel runat="server"  ID="dd2" Visible="false"> 
            <tr>
            <td style="text-align:center;">
          OLD LOGO  :</td>
            <td style="text-align:center;">
             ...
             <tr>
            <td style="text-align:center;">
                 <% if (Px.OLD_PRODUCT_LOGO != "")
               {
                   Response.Write("<a href=" + "../tm/" + Px.OLD_PRODUCT_LOGO + " target='_blank'>View</a>");        
         }  else { Response.Write("NONE"); 
            ...
            <td style="text-align:center;">
                  <% if (Px.NEW_PRODUCT_LOGO != "")
               {
                   Response.Write("<a href=" + "../tm/" + Px.NEW_PRODUCT_LOGO + " target='_blank'>View</a>");        
         }  else { Response.Write("NONE"); 
