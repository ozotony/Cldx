namespace cld.admin.tm.acceptance_unit
{
    ...
    public class ced : Page
    {
        ...
        protected void btnAll_Click(object sender, EventArgs e)
        {
            this.Session["f"] = "";
            this.Session["t"] = "";
            base.Response.Redirect("./ced.aspx");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((this.fromdate != "") && (this.todate != ""))
            {
                ...
                this.g_utotal = this.z.getTotalEntriesByDate("7", this.fromdate, this.todate);
                this.g_new = this.z.getTotalEntryCountStageByDate("7", "Not Opposed", this.fromdate, this.todate);
                this.g_treated = this.z.getTotalEntryCountStageByDate("7", "", this.fromdate, this.todate);
                this.g_rejected = this.z.getTotalEntryCountByStage("7", "Defered");
            }
            else
            {
                this.g_total = this.z.getTotalEntries("");
                this.g_utotal = this.z.getTotalEntries("7");
                this.g_new = this.z.getTotalEntryCountByStage("7", "Not Opposed");
                this.g_treated = this.z.getTotalEntryCountByStage("7", "");
                this.g_rejected = this.z.getTotalEntryCountByStage("7", "Defered");
            }
