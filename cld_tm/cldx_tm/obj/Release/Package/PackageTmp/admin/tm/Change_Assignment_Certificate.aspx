<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change_Assignment_Certificate.aspx.cs" Inherits="cld.admin.tm.Change_Assignment_Certificate2" %>
    ...
    <form class="form-login" role="form">
        ...
        <div style="width:98%; margin:auto; height:100%;   border: 6px solid #1861a4;">
            ...
            <div class="form-group">
             ...
             I hereby certify that your name has been entered on the Register as Proprietor(s) of the trademark <b>  <% Response.Write(c_mark.product_title.ToUpper()); %> </b>  with File Number <b>  <% Response.Write(c_mark.reg_number.ToUpper()); %> </b>  and RTM no <b>  <% Response.Write(c_stage.rtm.ToUpper()); %> </b> shown above in the name of </b> <% Response.Write(xp[0].newApplicantName.ToUpper()); %>  </b> of <b>  <% Response.Write(xp[0].newApplicantAddress.ToUpper()); %> </b> in class <b>  <% Response.Write(c_mark.nice_class.ToUpper()); %> </b>  in respect of <b>  <% Response.Write(c_mark.nice_class_desc /*t.getNationalClassDesc(c_mark.nice_class.ToUpper())*/); %> </b> pursuant to the deed of Assignment dated  <b>   <% Response.Write(xp[0].assignment_date.ToUpper()); %> </b> .
<br/>
                <br/>
                <br/>
                <br/>
...
<b>Federal Capital Territory Abuja, Nigeria.</b> <br/>
            ...
            <div  class="form-group" style="text-align: right">
                ...
                <b>&nbsp;&nbsp;&nbsp;&nbsp;   <% Response.Write(vofficer); %> </b> <br/>
