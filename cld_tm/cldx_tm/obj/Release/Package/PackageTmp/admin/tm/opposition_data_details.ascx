<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="opposition_data_details.ascx.cs" Inherits="cld.admin.tm.opposition_data_details" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="true">
                    <asp:ListItem Value="Opposed">Opposed</asp:ListItem>
                    <asp:ListItem Value="Not Opposed" >Not Opposed</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
