...
namespace cld.admin.tm.certification_unit
{
    public partial class generic_profile : System.Web.UI.Page
    {
        ...
        {
            Session["profileUrl"] = null; Session["profileUrl"] = "../certification_unit/generic_profile.aspx";
            ...
            lt_mi_n = z.getGwalletRSCnt("4", "New");
            lt_mi_t = z.getGwalletRSCnt("4", "Treated");
            lt_mi_k = z.getGwalletRSCnt("4", "Kiv");
            lt_mi_c = z.getGwalletRSCnt("4", "Contact");
        }
    }
}