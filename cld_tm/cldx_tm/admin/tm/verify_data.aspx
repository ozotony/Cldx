<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verify_data.aspx.cs" Inherits="cld.admin.tm.verify_data" %>
   ...
   <div>
    <div class="container">
        ...
        <div class="content">
          ...
          <tr>
            <td  class="tbbg">WELCOME TO THE VERIFICATION UNIT</td>
          </tr>
          <tr >
            <td align="center">
...
&nbsp;&nbsp;
  ...
  <strong>Note That Application that exceed 30 days in this unit will automatically be moved to the next unit. </strong> 
</div>
        ...
        <thead>
            <tr>
                ...
                <th st-sort="req_type" class="tbbg2">REQUEST TYPE</th>
                 ...
                 <th st-sort="Duration" class="tbbg2"> Duration in Verification</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" >
              ...
              <%-- <a href="./g_application_details.aspx?x={{row.log_staff}}"><i class="fa fa-link"></i></a>--%>
                    <a href="./v_data_details.aspx?x={{row.xid}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="./v_data_details.aspx?x={{row.xid}}"> <i class="fa fa-external-link"></i></a>
            </td>
