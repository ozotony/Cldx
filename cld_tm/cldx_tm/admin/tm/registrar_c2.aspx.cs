...
{
    using cld.Classes;
    public partial class registrar_c2 : System.Web.UI.Page
    {
        public string admin = "0";
        public int back;
        public string criteria = "";
        public string criteria_type = "";
        public string data_status = "Registered";
        ...
        //    this.dateFrom = this.z.formatSearchDate2(this.datepickerFrom.Value);
        //    this.dateTo = this.z.formatSearchDate2(this.datepickerTo.Value);
        ...
        //        //  Label1.Text = this.z.getNewAdminSearchMarkInfoRS2(this.stage, this.data_status, this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo); ;
        ...
        //    PopulateData(Convert.ToInt32(pageNo), 1000);
        //}
        ...
        //    pz = z.getNew_RowCount(this.stage, this.data_status);
        ...
        //    this.gvX.DataSource = this.lt_m;
        //    this.gvX.DataBind();
        //    int i = Convert.ToInt32(aa.RowRanks);
        //    foreach (GridViewRow row in this.gvX.Rows)
        //    {
        //        Label Id = row.FindControl("lblSerial") as Label;
        //        if (pz.Count() <= i)
        //        {
        //            return;
        //        }

        //        Id.Text = pz[i].RowRanks;
        //        i++;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                ...
                //  int kk = z.getNew_RowCount(this.stage, this.data_status).Count();
                ...
                // ViewState["TotalRecord"] = (z.getNew_RowCount(this.stage, this.data_status)).Count;// GetTotalCount();
                //ViewState["NoOfRecord"] = 1000;
