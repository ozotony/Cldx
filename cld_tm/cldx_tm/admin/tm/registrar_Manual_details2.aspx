<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrar_Manual_details2.aspx.cs" Inherits="cld.admin.tm.registrar_Manual_details2" %>
     ...
     <table width="100%">
            ...
            <div style="float:left;width:100%;">
                <asp:DropDownList ID="DropDownList1" onselectedindexchanged="itemSelected"  AutoPostBack="true" runat="server">
                    ...
                    <asp:ListItem Value="7">Approve</asp:ListItem>
                </asp:DropDownList>
