namespace cld.gf
{
    ...
    public partial class g_application_docs : Page
    {
        ...
        private void upload_Clicked(object sender, EventArgs e)
        {
            if (this.Session["new_miID"] != null)
            {
                ...
                if (((this.Session["new_miID"] != null) && (this.Session["new_miID"].ToString() != "")) && ((this.Session["pwalletID"] != null) && (this.Session["pwalletID"].ToString() != "")))
                {
                    ...
                    {
                        if ((this.Session["hwalletID"] != null) && (this.Session["hwalletID"].ToString() != ""))
                        {
                    ...
                    else if (this.t.updateGPwalletStage(this.Session["pwalletID"].ToString(), "5") != "")
                    {
                        if (((this.Session["vid"] != null) && (this.Session["vid"].ToString() != "")) && ((this.Session["xgt"] != null) && (this.Session["xgt"].ToString() != "")))
                        {
                ...
                else if ((this.Session["hwalletID"] != null) && (this.Session["hwalletID"].ToString() != ""))
                {
                    base.Response.Redirect(ConfigurationManager.AppSettings["ipo_profile_page"]);
                }
                else
