<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pubview.aspx.cs" Inherits="cld.admin.tm.x_unit.pubview" %>
...
<body>
    ...
    <table width="100%"  border="0" id="insert_news">
      ...
      <tr>
       ...
       <tr>
            <td align="left">
            <% Response.Write(t.getFormattedAddressByID(lt_app[0].addressID.ToUpper())); %>.</td>
        </tr>
        <tr>
            <td align="left">
                <strong>Agent:</strong> <% Response.Write(lt_rep[0].xname); %> (<em><% Response.Write(lt_rep[0].agent_code.ToUpper()); %></em> ),<br />   <% Response.Write(t.getFormattedAddressByID(lt_rep[0].addressID)); %>. </td>
        </tr>
    </table>    
       </td>
       </tr>
