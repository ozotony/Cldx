...
namespace cld.admin.tm.search_unit
{
    public partial class generic_profile : System.Web.UI.Page
    {
        ...
        {
            Session["profileUrl"] = null; Session["profileUrl"] = "../search_unit/generic_profile.aspx";
            ...
            lt_mi_n = z.getGwalletRSCnt("2", "New");
            lt_mi_t = z.getGwalletRSCnt("2", "Treated");
            lt_mi_k = z.getGwalletRSCnt("2", "Kiv");
            lt_mi_c = z.getGwalletRSCnt("2", "Contact");
        }
    }
}