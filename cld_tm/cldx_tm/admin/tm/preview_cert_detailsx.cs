namespace cld.admin.tm
{
    ...
    public class preview_cert_detailsx : UserControl
    {
        public string admin = "";
        ...
        public zues.Adminz c_tm_admin_details = new zues.Adminz();
        ...
        {
            base.Response.Redirect("./preview_certs.aspx");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (base.Request.QueryString["x"] != null)
            {
                ...
                this.c_tm_admin_details = this.z.getTmAdminDetailsByID(this.lt_tm_office[0].xofficer);
            }
            else
            {
                base.Response.Redirect("./preview_certs.aspx");
