<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register_Manual22.aspx.cs" Inherits="cld.admin.tm.Recordal2.Register_Manual22" %>
...
&nbsp;&nbsp;
        ...
        <thead>
            <tr>
                ...
                <th st-sort="reg_dt" class="tbbg2">RTM No</th>
                 <th st-sort="reg_no" class="tbbg2"> FILE/TP  Number</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
                ...
                <td align="center">
              <%-- <a href="registrar_Manual_details.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>--%>
               <a href="Generic_registrar_data_detailsB2.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="Generic_registrar_data_detailsB2.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"> <i class="fa fa-external-link"></i></a>
            </td>
