<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_details6bb.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_details6bb" %>
    ...
    <body>
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
            <td style="text-align:center;">
               <% Response.Write(vp.Sys_ID); %></td>
            <td style="text-align:center;">
                 <% Response.Write(vp.Surname); %></td>
        </tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
           <% Response.Write(vp.CompanyAddress); %></td>
        </tr>               
        ...
        <tr>
            <td style="text-align:center;">
               <% Response.Write(vp.PhoneNumber); %></td>
            <td style="text-align:center;">
                 <% Response.Write(vp.Email); %></td>
        </tr>
            <tr>
            <td colspan="2" style="background-color:#1C5E55; color:#ffffff; text-align:center; font-weight:bold;">
