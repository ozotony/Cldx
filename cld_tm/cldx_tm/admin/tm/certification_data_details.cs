namespace cld.admin.tm
{
    ...
    public class certification_data_details : UserControl
    {
        public string admin = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (base.Request.QueryString["x"] != null)
            {
                ...
                for (int i = 0; i < this.lt_tm_office.Count; i++)
                {
                  ...
                  //  this.xcomments = xcomments + "COMMENT BY: <strong>" + this.lt_x_admin_details.xname.ToUpper() + "( " + getCurrentStage(this.lt_tm_office[i]) + " UNIT)</strong><br />   Date: <strong>" + this.lt_tm_office[i].reg_date.ToUpper() + "</strong>";
            ...
            {
                base.Response.Redirect("./certification.aspx");
            }
        }
