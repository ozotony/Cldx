...
{
    public partial class acceptance_prt : Page
    {
        public string admin = "0";
        public int back;
        public string criteria = "";
        public string criteria_type = "";
        public string data_status = "acc_printed";
        ...
        {
            base.Response.Redirect("acceptance_prt.aspx");
        }
        ...
        protected void gvX_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "TmViewClick")
            {
                ...
                base.Response.Redirect("acceptance_prt_details.aspx?x=" + str);
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.max = Convert.ToInt32(ConfigurationManager.AppSettings["a_unit_limit"]);
            if (!base.IsPostBack)
            {
