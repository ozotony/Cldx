<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="old_g_applications.aspx.cs" Inherits="cld.admin.tm.verification_unit.old_g_applications" %>
        ...
        <div class="content">
          ...
          <tr >
            <td colspan="8" align="center" class="tbbg"><asp:DropDownList ID="selectSearchCriteria" runat="server" AutoPostBack="False">
                ...
                <asp:ListItem Text="Registration number" Value="reg_no"></asp:ListItem>
                </asp:DropDownList>
&nbsp;&nbsp;
          ...
          <tr >
            ...
            <td width="15%" class="tdcolheader">APPLICANT NAME</td>
            <td width="20%" class="tdcolheader">ITEM CODE</td>
        ...
        <tr>
            ...
            <td align="center">
                <%=lt_mi[i].reg_no.ToString() %>
            </td>
            <td  align="center">
                <%= z.getG_ApplicantByLogstaff(lt_mi[i].log_staff)[0].xname%>
            </td>
            <td align="center">
                <%= lt_mi[i].item_code.ToString() %>
            </td>
            <td align="center">
               <% =z.getG_ValidationIDByApp_infoID(lt_mi[i].id)%>
            </td>
            <td align="center">
                <%= lt_mi[i].reg_date.ToString() %>
            </td>
            <td align="center">
                <% if (z.getG_TmOfficeByPID(lt_mi[i].log_staff) != "") { Response.Write(z.getG_TmOfficeByPID(lt_mi[i].log_staff)); } else { Response.Write("None"); }%></td>
            <td align="center">
               <a href="g_application_details.aspx?x=<%= lt_mi[i].log_staff.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>
