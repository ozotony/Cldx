<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_ack.aspx.cs" Inherits="cld.gf.g_ack"  MaintainScrollPositionOnPostback="true"%>
    ...
    <div id="searchform">                
     ...
     <table width="100%">
            ...
            <div style="float:left;width:100%;">
                ...
                <asp:Button ID="BtnAck" runat="server" Text="Back to Dashboard" class="button" 
                    onclick="BtnAck_Click"/>
                </div>
           </td>
        </tr>
        </table>  
