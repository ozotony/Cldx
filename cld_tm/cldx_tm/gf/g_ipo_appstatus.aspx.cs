...
namespace cld.gf
{
    using admin;
    using Classes;
    public partial class g_ipo_appstatus : System.Web.UI.Page
    {       
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            if (this.xref.Text != "")
            {
                ...
                {
                    this.showt = 1;
                    Session["g_pwallet"] = g_pwallet;Session["agt"]=g_pwallet.applicantID;
        ...
        public void showStatus(Classes.XObjs.G_Pwallet g_p)
        {
            ...
            if (g_p.status == "2")
            {
                ...
                { data_status = "Contacting Agent";}
                else if (g_p.data_status == "New")
        ...
        {
            if ((Session["agt"] != null) && (Session["agt"].ToString() != "") && (Session["xvid"] != null) && (Session["xvid"].ToString() != ""))
            {
                Response.Redirect("./g_ipo_rep_ack.aspx?XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=" + Session["agt"].ToString() + "&0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=" + Session["xvid"].ToString());               
            }
        }
