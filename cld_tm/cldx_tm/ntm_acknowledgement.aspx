<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ntm_acknowledgement.aspx.cs" Inherits="cld.ntm_acknowledgement" %>
...
<table style="width:1000px;" align="center">
        <tr id="ack">
        <td style="width:1000px; text-align:center;"  align="center">
    <table   class="form" align="center" >
       ...
       <tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
                  <% Response.Write(ret.DecodeChar(c_app.xname)); %></td>
        </tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
                 <% Response.Write(t.getFormattedAddressByID(ret.DecodeChar(c_app.addressID))); %></td>
        </tr>
         <tr>
            <td style="text-align:center;" colspan="2">
                &nbsp;</td>                                
        ...
        <tr>
            <td style="text-align:center;">
                ...
                <td style="text-align:center;">
                     <% Response.Write(t.getAgentEmail1ByID(ret.DecodeChar(c_app.addressID))); %></td>
       </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
                <% Response.Write(ret.DecodeChar(c_mark.product_title)); %></td>
        </tr>
         <tr>
            <td style="text-align:center;" colspan="2">
                &nbsp;</td>                                
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <asp:Label ID="Label4" runat="server" Text="Label"><% Response.Write(ret.DecodeChar(c_mark.nice_class)); %></asp:Label></td>
        </tr>
        <tr>
            <td style="text-align:center;" colspan="2">
                &nbsp;</td>                                
        ...
        <tr>
            <td style="text-align:center;" colspan="2"> 
                                <asp:Label ID="Label5" runat="server" Text="Label"><% Response.Write(ret.DecodeChar(c_mark.nice_class_desc)); %></asp:Label>
                                </td>
        </tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2"> 
                                <asp:Label ID="Label7" runat="server" Text="Label"><% Response.Write((ret.DecodeChar(c_mark.disclaimer)) ); %></asp:Label></td>
        </tr>
           <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">   
                ...
                <% } else  { Response.Write(ret.DecodeChar(c_mark.product_title)); } %>
                </td>
        </tr>
           <tr>
            <td colspan="2">&nbsp;</td>
        ...
        <tr>
         ...
         <tr>
            ...
            <td style="text-align:center;">
                <% Response.Write(ret.DecodeChar(c_rep.xname)); %></td>
        </tr>
         <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
            <% Response.Write(t.getFormattedAddressByID(ret.DecodeChar(c_rep.addressID))); %></td>
        </tr>               
        ...
        <tr>
            ...
            <td style="text-align:center;">
                  <% Response.Write(t.getAgentEmail1ByID(ret.DecodeChar(c_rep.addressID))); %></td>
        </tr>
           <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
