<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_apps4.aspx.cs" Inherits="cld.admin.tm.x_unit.edit_apps4" %>
...
<body>
    ...
    <table  id="applicantForm" align="center" width="100%" style="border:1px dashed #000; font-size:11px;">
      <tr>
        ...
        <tr>
             <td colspan="2" style="font-size:18pt;line-height:115%;" align="center">
                <asp:TextBox ID="txt_search" Visible="false" runat="server" Width="400px" 
        ...
        <tr>
             <td colspan="2" style="font-size:18pt;line-height:115%;" align="center">
                <asp:Button ID="SearchApplicant" runat="server" Visible="false" Text="Search For Application" 
