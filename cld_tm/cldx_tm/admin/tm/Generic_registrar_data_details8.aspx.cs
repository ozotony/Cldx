...
{
    public partial class Generic_registrar_data_details8 : System.Web.UI.Page
    {
        ...
        protected void rbValid_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.rbValid.SelectedValue == "Update2" || this.rbValid.SelectedValue == "Vf")
            {
                this.rbval_text = "Update2";
                this.admin_status = "14";
                Verify.Visible = true;
        ...
        protected void Verify_Click(object sender, EventArgs e)
        {
            ...
            if (this.rbValid.SelectedValue == "Vf")
            {
                ...
                base.Response.Redirect("./g_Recordal2.aspx");
            }
