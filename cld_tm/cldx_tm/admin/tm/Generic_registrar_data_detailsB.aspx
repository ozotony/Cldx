<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_detailsB.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_detailsB" %>
      ...
      <%--  <tr>
        ...
        <tr>
            ...
            <td align="center" colspan="4">   
                <% if (cert_show2)
               {
                   Response.Write("<a href=" + "../tm/" + cert.Pub_Doc + " target='_blank'>View</a>");        
         }  else { Response.Write("NONE"); 
