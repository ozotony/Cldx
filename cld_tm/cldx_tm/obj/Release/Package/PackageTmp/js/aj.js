...
function doBlock() {
    $.blockUI({ message: '<img src="images/ajax_loader.gif" /><br/>Please wait...<br/> ', css: { backgroundColor: '#376631', color: '#fff', width: '50%', top: '30%', left: '25%' } });
