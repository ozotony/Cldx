<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rejection_slip.aspx.cs" Inherits="cld.admin.tm.rejection_slip" %>
...
&nbsp;&nbsp;
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" >
                ...
                <td align="center">
               <a href="./rejection_slip_audit_details.aspx?x={{row.xid}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="./rejection_slip_audit_details.aspx?x={{row.xid}}"> <i class="fa fa-external-link"></i></a>
            </td>
