<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_application_details.aspx.cs" Inherits="cld.admin.tm.search_unit.g_application_details" %>
            ...
            <td align="center" colspan="4">
                ...
                <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" 
                    ...
                    <asp:ListItem Value="Valid">Valid</asp:ListItem>
                     <asp:ListItem Value="Ping">Send Email</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
          <tr>
