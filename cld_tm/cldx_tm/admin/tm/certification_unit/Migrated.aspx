<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Migrated.aspx.cs" Inherits="cld.admin.tm.certification_unit.Migrated" %>
...
&nbsp;&nbsp;
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
                ...
                <td align="center">
              <%-- <a href="Generic_registrar_data_details2.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>--%>
                 <a href="Generic_registrar_data_detailsC.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>
                
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="Generic_registrar_data_detailsC.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"> <i class="fa fa-external-link"></i></a>
            </td>
