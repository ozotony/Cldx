...
{
    public partial class Change_Renewal_Certificate : System.Web.UI.Page
    {
        ...
        public string vmonth2;
        public String vday2;
        public int vyear2;
        public DateTime xdate3;
        // public tm t = new tm();
        ...
        public List<Recordal_Detail2> xp = new List<Recordal_Detail2>();
        ...
        public void vupdate()
        {
                ...
                )
            {
                ...
                if ((vid != null))
                {
                    ...
                    xp = ret.get_RecordalDetail2(vd[0].Detail_Id);

                    string xdate = xp[0].Renewal_DueDate;
                    DateTime xdate2 = Convert.ToDateTime(xdate);

                    vmonth = xdate2.ToString("MMMM");

                     vday =Convert.ToString(xdate2.Day) + getDayFormat(Convert.ToString(xdate2.Day));

                      vyear = xdate2.Year;

                xdate3=xdate2.AddYears(14);


                vmonth2 = xdate3.ToString("MMMM");

                vday2 =Convert.ToString(xdate3.Day)+ getDayFormat(Convert.ToString(xdate3.Day));// xdate3.Day;
