<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xrefill.aspx.cs" Inherits="cld.xrefill" %>
    ...
    <table align="center" width="100%" class="form">
        ...
        <tr>
            <td width="50%" align="left">
                ...
                <div align="center">AN APPLICATION HAS WITH THE TRANSACTION ID <strong>"<%=validationID.ToUpper() %>"</strong> HAS ALREADY BEEN 
                    STARTED!!!<br />
                    <br />
                    PLEASE CLICK ON THE LINK BELOW TO COMPLETE OR EDIT YOUR APPLICATION</div>
                <br />
                </td>
        </tr>
        ...
        <tr>
            <td  align="center">
                ...
                <asp:Button ID="editApplication" runat="server" Text="EDIT APPLICATION" 
                    class="button" onclick="editApplication_Click" Visible="False" />
                </td>
        </tr>
