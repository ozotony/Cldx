<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="s_data_details2.aspx.cs" Inherits="cld.admin.tm.s_data_details2" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="container">
       ...
       <tr>
        ...
        <% Response.Write(xcomments); %>
                ...
                <asp:Panel ID="vsearch" Visible="false" runat="server"> 
                 <tr>
                   <td class="tbbg" colspan="2" align="center">
                       &nbsp;
                -- VIEW SEARCH1 RESULT --
                 ...
                 <tr>
                   <td  colspan="2" align="center">
                     <asp:Button ID="Button2" runat="server" Text="View Search 1" class="button" 
                            onclick="btnViewSearchReport_Click2"  />
        ...
        <tr>
            <td class="tbbg" colspan="2" align="center">
                ...
                <asp:Button ID="btnPerformSearch" runat="server" Text="Perform Search" 
                            class="button" onclick="btnPerformSearch_Click" />
        ...
        <% } else {%>
         <tr>
            <td class="tbbg" colspan="2" align="center">
                ...
                <asp:Button ID="btnViewSearchReport" runat="server" Text="View Search" class="button" 
                            onclick="btnViewSearchReport_Click"  />
        ...
        <tr>
         ...
         <tr>
            <td colspan="2">
                Attach Document 1: <asp:FileUpload ID="doc1" runat="server" /><br />
                Attach Document 2: <asp:FileUpload ID="doc2" runat="server" /><br />
                Attach Document 3: <asp:FileUpload ID="doc3" runat="server" /><br />
                  </td>
        </tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged">
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="Verify" runat="server" Text="Submit Search Report" OnClick="Verify_Click" class="button" />
            </td>
        </tr>
    </table>
        </div>
