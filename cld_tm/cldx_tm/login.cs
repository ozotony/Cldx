    ...
    public class login : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           if (!(Page.IsPostBack)) {
            ...
            string ClientIP = cld.login.GetClientIPAddress(Context.Request); 
        }
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
           ...
           // this.adminID = this.z.a_xadminz(ody.EncryptString(this.xemail.Text, file_len, file_string), ody.EncryptString(this.xpassword.Text, file_len, file_string));
             this.adminID = this.z.a_xadminz(this.xemail.Text.Trim(), this.xpassword.Text.Trim(),serverpath);
            ...
            if (this.adminID != "0")
            {
                ...
                if (succ != "")
                {
                    ...
                    {
                        case "1":
                            base.Response.Redirect("./admin/tm/x_unit/profile.aspx");
                            break;

                        case "2":
                            base.Response.Redirect("./admin/tm/agent_unit/profile.aspx");
                            break;

                        case "3":
                            base.Response.Redirect("./admin/tm/verification_unit/profile.aspx");
                            break;

                        case "4":
                            base.Response.Redirect("./admin/tm/search_unit/profile.aspx");
                            break;

                        case "5":
                            base.Response.Redirect("./admin/tm/examiners_unit/profile.aspx");
                            break;

                        case "6":
                            base.Response.Redirect("./admin/tm/acceptance_unit/profile.aspx");
                            break;

                        case "7":
                            base.Response.Redirect("./admin/tm/publication_unit/profile.aspx");
                            break;

                        case "8":
                            base.Response.Redirect("./admin/tm/opposition_unit/profile.aspx");
                            break;

                        case "9":
                            base.Response.Redirect("./admin/tm/certification_unit/profile.aspx");
                            break;

                        case "10":
                           
                           // base.Response.Redirect("./admin/tm/registrar_unit/profile_index.aspx");
                            base.Response.Redirect("./admin/tm/registrar_unit/tm_profile.aspx");
                            return;

                        case "11":
                            base.Response.Redirect("./admin/tm/cash_unit/profile.aspx");
                            return;
                        case "12":
                            base.Response.Redirect("./admin/tm/search_unit2/profile.aspx");
                            return;

                        case "13":
                            base.Response.Redirect("./admin/tm/Recordal2/profile.aspx");
                            return;

                        case "14":
                            base.Response.Redirect("./admin/tm/x_unit/cldadmin.aspx");
                            return;

                        case "15":
                            base.Response.Redirect("./admin/tm/Appeal_Rejection/profile.aspx");
                            return;
                    }
                }
                else
