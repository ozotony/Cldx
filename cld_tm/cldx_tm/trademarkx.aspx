<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trademarkx.cs" Inherits="cld.trademarkx" MaintainScrollPositionOnPostback="true" %>
       ...
       <table align="center" width="100%" class="form">
        ...
        <tr>
            ...
            <td align="left" class="style1">
                <asp:TextBox ID="rep_xname" runat="server" Width="400px" 
                    CssClass="textbox" ></asp:TextBox>
                <% if (rep_name_text == "1")
                   { %>&nbsp;<img src="images/checkmark.gif" alt="" width="16px" height="16px" />
                <% } if (enable_RepSave == "0")
