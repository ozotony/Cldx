<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Batch_pubview.aspx.cs" Inherits="cld.admin.tm.publication_unit.Batch_pubview" %>
    ...
    <table width="100%"  border="0" id="insert_news">
      ...
      <tr>
       <td align="center">
        ...
        <tr>
            <td align="left">
                <strong>Agent:</strong> <% Response.Write(lt_rep[0].xname); %> (<em><% Response.Write(lt_rep[0].agent_code.ToUpper()); %></em> ),   <% Response.Write(t.getFormattedAddressByID(lt_app[0].addressID)); %> </td>
        </tr>
    </table>    
       </td>
       </tr>
