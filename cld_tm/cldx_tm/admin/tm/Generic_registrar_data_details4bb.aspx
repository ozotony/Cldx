<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_details4bb.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_details4bb" %>
       ...
       <tr>
        ...
        <tr>
           ...
           <% Response.Write(xusr7); %>   :</td>
            ...
            <tr>
            <td style="text-align:center;">
                 <% Response.Write(Px.description); %></td>
            <td style="text-align:center;">
                  </td>
        </tr>
           ...
           <tr>
            <td style="text-align:center;">
                 ...
                 <% if (Px.UPLOADPATH != "")
               {
                   Response.Write("<a href=" + "../tm/" + Px.UPLOADPATH + " target='_blank'>View</a> <br/>");        
         }  else { Response.Write("NONE"); 
                 ...
                 <% if (Px.UPLOADPATH2 != "")
               {
                   Response.Write("<a href=" + "../tm/" + Px.UPLOADPATH2 + " target='_blank'>View</a> <br/>");        
         }  else { Response.Write("NONE"); 
                  ...
                  <% if (Px.UPLOADPATH3 != "")
               {
                   Response.Write("<a href=" + "../tm/" + Px.UPLOADPATH3 + " target='_blank'>View</a>");        
         }  else { Response.Write("NONE"); 
