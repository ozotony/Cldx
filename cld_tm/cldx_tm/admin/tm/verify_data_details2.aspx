<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verify_data_details2.aspx.cs" Inherits="cld.admin.tm.verify_data_details2" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="Verify" runat="server" Text="Verify" OnClick="Verify_Click" class="button" />
            </td>
        </tr>
    </table>
        </div>
