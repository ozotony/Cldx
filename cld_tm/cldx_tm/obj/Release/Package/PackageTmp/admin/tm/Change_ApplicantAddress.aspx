<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change_ApplicantAddress.aspx.cs" Inherits="cld.admin.tm.Change_ApplicantAddress" %>
...
TRADEMARKS, PATENTS AND DESIGNS REGISTRY
            ...
            <div style="top: 0; width: 80%; height:  auto; margin:  auto;"><div class="pageheader blue"><p style="height: 100%; font-size: 18px">CHANGE OF APPLICANT ADDRESS</p></div>
            
            <div class="form-group">
                <label for="email">Old Applicant Address</label>
                <div>
                    <input type="text" ng-model="ApplicantAddress" id="email" class="form-control" disabled />

                </div>
            </div>
            <div class="form-group">
                <label for="password">New Applicant Address</label>
                <div>
                    <input type="text" ng-model="ApplicantAddress2" id="password" class="form-control" />
