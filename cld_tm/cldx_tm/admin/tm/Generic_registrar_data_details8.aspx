<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_details8.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_details8" %>
    ...
    <form id="form1" runat="server">
     <div class="container">
        <div class="sidebar no-print"  >
            <a href="./acceptance_unit/profile.aspx">PROFILE</a> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./acceptance_unit/aed.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
 ...
 <% Response.Write(xhistory); %>  
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="true">
                    <asp:ListItem Value="Update2" >Update Recordal</asp:ListItem>

                    <asp:ListItem Value="Vf" >Send Back to Verification Unit</asp:ListItem>
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:TextBox ID="comment" runat="server"  Visible="false" Height="50px" TextMode="MultiLine" Width="98%"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td align="center" colspan="2">
               ...
               <%-- <a class="button" href="Change_Name_Certificate.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=<%Response.Write(g_pwallet.validationID); %>">View Certificate</a>--%>
               <asp:Button ID="Button1" Visible="false" runat="server" Text="View Certificate" OnClick="Verify_Click2" class="button no-print" />
