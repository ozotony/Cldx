<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="acceptance_slip_audit_details.aspx.cs" Inherits="cld.admin.tm.acceptance_slip_audit_details"  MaintainScrollPositionOnPostback="true" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center" colspan="2">
               ...
               <input type="button" name="Printform" id="btn_view_slip" value="View Slip" class="button" onclick="window.open('./acceptance_slip_details.aspx?x=<%=pID %>');" />&nbsp;
