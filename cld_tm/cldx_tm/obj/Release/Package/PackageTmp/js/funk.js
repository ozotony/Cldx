...
function printGenericAdminGf(node) {
...
function Popup(node) {
    ...
    var content = document.getElementById(node).innerHTML;
    var mywindow = window.open('', document.getElementById(node), 'height=850,width=600');
    mywindow.document.write('<html><head><title>my div</title>');
    mywindow.document.write('<link rel="stylesheet" media="print" href="../../../css/print_style2.css" type="text/css" />');
...
function printSearchReport(node) {
...
function printAdminJournal(node) {
