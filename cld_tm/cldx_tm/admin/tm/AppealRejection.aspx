<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppealRejection.aspx.cs" Inherits="cld.admin.tm.AppealRejection" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" data-ng-app="myModule">
<head runat="server">
    <title>APPEAL REJECTION DATA</title>
...
<body ng-controller="myController34">
    <form id="form1" runat="server">
   <div>
    <div class="container">
        <div class="sidebar">
            <a href="./Appeal_Rejection/profile.aspx">PROFILE</a> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./verification_unit/ved.aspx">VIEW STATISTICS</a>
      <a href="../tm/x_unit/profile4.aspx" ng-show="xvv" class="blinkytext" > <blink> <span id="txtblinkingtext" class="label label-danger" ng-bind="vcount"></span> </blink> </a>
             <a style="width=200px" target="_blank" href="../tm/x_unit/profile4.aspx">MAIL BOX</a> 
             </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
    ...
    <div class="shadow right">&nbsp;</div>
          ...
          <tr>
            <td  class="tbbg">WELCOME TO THE APPEAL REJECTION UNIT</td>
          </tr>
          <tr >
            <td align="center">
            ...
            <td style="text-align:center;" >
                <asp:GridView ID="gvX" runat="server" AllowPaging="True" AutoGenerateColumns="False" CaptionAlign="Left" CellPadding="4" EnableModelValidation="True" ForeColor="#000000" GridLines="Both" HorizontalAlign="Left" onrowcommand="gvX_RowCommand"   onpageindexchanging="gvX_PageIndexChanging"    style="margin-top: 0px; width:100%; font-size:12px;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VIEW" >
                             <ItemTemplate>
                              <asp:HyperLink ID="btnnewTab" Text="New Tab" runat="server" Target="_blank" NavigateUrl='<%# string.Format("./v_data_details.aspx?x={0}", Eval("xid")) %>' />
                             </ItemTemplate>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}" >
              ...
              <%-- <a href="./g_application_details.aspx?x={{row.log_staff}}"><i class="fa fa-link"></i></a>--%>
                    <a href="./AppealRejection2.aspx?x={{row.xid}}&x2={{row.id2}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="./AppealRejection2.aspx?x={{row.xid}}&x2={{row.id2}}"> <i class="fa fa-external-link"></i></a>
            </td>
