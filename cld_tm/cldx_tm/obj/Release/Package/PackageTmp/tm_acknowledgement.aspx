<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tm_acknowledgement.cs" Inherits="cld.tm_acknowledgement" %>

<%@ Register src="tm_ark.ascx" tagname="tm_ark" tagprefix="uc1" %>
...
<body>
    ...
    <div>
        ...
        <uc1:tm_ark ID="tm_ark1" runat="server" />
