<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAmendMentDetail.aspx.cs" Inherits="cld.admin.tm.EditAmendMentDetail" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="Verify" runat="server" Text="Approve" OnClick="Verify_Click" class="button" />
            </td>
        </tr>
    </table>
        </div>
