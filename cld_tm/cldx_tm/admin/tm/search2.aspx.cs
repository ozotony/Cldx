...
namespace cld.admin.tm
{
    ...
    public partial class search2 : Page
    {
        ...
        public string data_status = "Search Conducted";
        ...
        {
            base.Response.Redirect("search2.aspx");
        }
        ...
        protected void gvX_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "TmViewClick")
            {
                ...
                base.Response.Redirect("s_data_details2.aspx?x=" + str + "&cri=" + this.Session["e_type"].ToString());
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
            //    this.stage = "3";
            //    this.data_status = "Search Conducted";
            //}
            //else if (this.e_type == "r")
            //{
            //    this.stage = "22";
            //    this.data_status = "Re-conduct search 1";
            //}
            //if (!base.IsPostBack)
            //{
