...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="registrar_data_details2.ascx.cs" Inherits="cld.admin.tm.registrar_data_details2" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" 
                    ...
                    <asp:ListItem Value="Registered" >Register</asp:ListItem>
