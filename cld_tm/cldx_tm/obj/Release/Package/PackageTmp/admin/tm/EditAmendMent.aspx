<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAmendMent.aspx.cs" Inherits="cld.admin.tm.EditAmendMent" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" data-ng-app="myModule">
<head runat="server">
    <title>AMENDMENT DATA</title>
   ...
   <div>
    <div class="container">
        <div class="sidebar">
            ...
            <a href="./rejection_slip.aspx">VIEW REFUSALS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
...
&nbsp;&nbsp;
         ...
         <tr >
            <td align="center">            
               <%-- <asp:Button ID="btnSearch" runat="server" Text="SEARCH" class="button" 
                ...
                <br />
                 Total Records :<strong> <%=x_cnt%></strong><br /><hr />--%>
              </td>
            </tr>          
            ...
            <td style="text-align:center;" >
                <asp:GridView ID="gvX" runat="server" AllowPaging="True" AutoGenerateColumns="False" CaptionAlign="Left" CellPadding="4" EnableModelValidation="True" ForeColor="#000000" GridLines="Both" HorizontalAlign="Left" onrowcommand="gvX_RowCommand"   onpageindexchanging="gvX_PageIndexChanging"    style="margin-top: 0px; width:100%; font-size:12px;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VIEW" >
                             <ItemTemplate>
                              <asp:HyperLink ID="btnnewTab" Text="New Tab" runat="server" Target="_blank" NavigateUrl='<%# string.Format("./rejection_slip_audit_details.aspx?x={0}", Eval("xid")) %>' />
                             </ItemTemplate>
            ...
            <tr>
                ...
                <th st-sort="req_type" class="tbbg2">REQUEST TYPE</th>
                 ...
                 <th  st-sort="tm_title" class="tbbg2">TITLE OF PRODUCT</th>
                   ...
                   <th  st-sort="xstat" class="tbbg2">AMENDMENT STATUS</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" >
                ...
                <td align="center">{{row.AmendmentStatus}}</td>
                ...
                <td align="center">
               <a href="./EditAmendMentDetail.aspx?x={{row.xid}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="./EditAmendMentDetail.aspx?x={{row.xid}}"> <i class="fa fa-external-link"></i></a>
            </td>
                
   <td> <a target="_blank" class="icon-bar" href="Generic_registrar_data_detailsAmendment.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.id}} "> <i class="fa fa-external-link"></i></a></td>
