<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_detailsC.aspx.cs" Inherits="cld.admin.tm.certification_unit.Generic_registrar_data_detailsC" %>
    ...
    <form id="form1" runat="server">
     <div class="container">
          <div class="sidebar no-print">
             <a href="./profile.aspx">MAIN PROFILE</a>
      ...
      <%--  <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <asp:ListItem Enabled="false" Value="Published" >Published</asp:ListItem>
                     <asp:ListItem Enabled="false" Value="Opposed" >Opposed</asp:ListItem>
                      <asp:ListItem Enabled="false" Value="Not Opposed" >Not Opposed</asp:ListItem>
                      <asp:ListItem Enabled="false" Value="Registered" >Registered</asp:ListItem>
