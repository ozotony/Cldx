<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="publication_data_details.cs" Inherits="cld.admin.tm.publication_data_details" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" 
                    ...
                    <asp:ListItem Value="Published" >Add to list</asp:ListItem>
