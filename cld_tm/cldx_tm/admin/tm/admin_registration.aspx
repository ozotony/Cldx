<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_registration.aspx.cs" Inherits="cld.admin.tm.admin_registration" %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="dsAllAdmins" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:cldConnectionString %>" 
                    SelectCommand="SELECT xID,xname FROM [xadminz_tm]  "></asp:SqlDataSource>
            </td>
        </tr>
         <% if (enable_EditTbl =="1")
  { %>
