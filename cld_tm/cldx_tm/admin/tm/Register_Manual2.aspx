<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register_Manual2.aspx.cs" Inherits="cld.admin.tm.Register_Manual2" %>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
              ...
              <%-- <a href="registrar_Manual_details.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>--%>
               <a href="Generic_registrar_data_detailsB.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="Generic_registrar_data_detailsB.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"> <i class="fa fa-external-link"></i></a>
            </td>
