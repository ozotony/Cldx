<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_registration3.aspx.cs" Inherits="cld.admin.tm.admin_registration2" %>
...
<body >
    ...
    <div class="container">
        <div class="sidebar">
            <a href="./x_unit/cldadmin.aspx">PROFILE</a>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <asp:SqlDataSource ID="dsRole" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [roles] where id=14"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td align="left">
                &nbsp;&nbsp;E-MAIL :             </td>
            <td align="left">
                <asp:TextBox ID="xemail" runat="server" Width="400px" AutoPostBack="true" ontextchanged="TextBox1_TextChanged" CssClass="textbox" ></asp:TextBox>
                <% if (email_text == "1")
                   { %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="dsAllAdmins" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:cldConnectionString %>" 
                    SelectCommand="SELECT xID,xname FROM [xadminz_tm] where xroleid='14'"></asp:SqlDataSource>
            </td>
        </tr>
         <% if (enable_EditTbl =="1")
  { %>
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="edit_xrole" runat="server" CssClass="textbox" 
                    DataSourceID="dsRole2" DataTextField="name" DataValueField="ID" >
                </asp:DropDownList>
