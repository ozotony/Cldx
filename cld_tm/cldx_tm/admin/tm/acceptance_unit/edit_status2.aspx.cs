        ...
        protected void SearchApplicant_Click(object sender, EventArgs e)
        {
            if (xref.Text != "")
            {
                ...
                if (lt_pw.Count > 0)
                {
                    ...
                    {
                        if ((lt_pw[0].stage.Trim() == "5") && (lt_pw[0].status.Trim() != "33") && (lt_pw[0].status.Trim() != "22") && ( (Convert.ToInt32(lt_pw[0].status.Trim()) <= 5) || ((lt_pw[0].data_status == "Kiv") && (Convert.ToInt32(lt_pw[0].status) == 14))))
                        {
