    ...
    public class eed : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((this.fromdate != "") && (this.todate != ""))
            {
                ...
                this.g_new = this.z.getTotalEntryCountStageByDate("3", "Search Conducted", this.fromdate, this.todate);
                this.g_treated = this.z.getTotalEntryCountStageByDate("3", "", this.fromdate, this.todate);
                this.g_rejected = this.z.getTotalEntryCountByStage("3", "X");
            }
            else
            {
                this.g_total = this.z.getTotalEntries("");
                this.g_utotal = this.z.getTotalEntries("3");
                this.g_new = this.z.getTotalEntryCountByStage("3", "Search Conducted");
