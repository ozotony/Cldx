<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppealRejection2.aspx.cs" Inherits="cld.admin.tm.AppealRejection2" %>
   ...
   <div>
    <div class="container">
        <div class="sidebar no-print">
            <a href="./Appeal_Rejection/profile.aspx">PROFILE</a>
       ...
       <tr>
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="Verify" runat="server" Text="Verify" OnClick="Verify_Click" class="button no-print" />
            </td>
        </tr>
    </table>
        </div>
