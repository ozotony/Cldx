<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change_ApplicantAddress2.aspx.cs" Inherits="cld.admin.tm.Change_ApplicantAddress2" %>
...
TRADEMARKS, PATENTS AND DESIGNS REGISTRY
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    <input type="text" ng-model="OldApplicantAddress" id="email" class="form-control"  />
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" ng-model="ApplicantAddress" id="password" class="form-control" />
