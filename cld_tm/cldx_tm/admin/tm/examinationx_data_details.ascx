<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="examinationx_data_detail.cs" Inherits="cld.admin.tm.examinationx_data_detail"%>
...
<div>
    <div class="container">
        <div class="sidebar">
            <a href="./examiners_unit/profile.aspx">PROFILE</a> 
            <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> 
            <a href="./examiners_unit/eed.aspx">VIEW STATISTICS</a>
    ...
    <table align="center" width="100%"  class="form">
       ...
       <tr>
        ...
        <% if (show_exam_docs == 1)
           { %>
          <tr>
            <td class="tbbg" colspan="2" align="center">  --- ATTACH DOCUMENTS --- 
                <br />
                (NOTE: EACH DOCUMENT SHOULD NOT EXCEED 3MB)</td>
        </tr>
           <tr>
            <td align="right">  Document 1:</td>
            <td align="left">  
                        <asp:FileUpload ID="exam_doc1" runat="server" />
                        </td>
        </tr>
           ...
           <tr>
            ...
            <td align="left">  
                        <asp:FileUpload ID="exam_doc2" runat="server" />
                        </td>
        </tr>
           ...
           <tr>
            ...
            <td align="left">  
                        <asp:FileUpload ID="exam_doc3" runat="server" />
                        </td>
        </tr>
        <% } %>
