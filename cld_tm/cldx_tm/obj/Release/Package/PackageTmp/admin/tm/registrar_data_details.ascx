...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="registrar_data_details.ascx.cs" Inherits="cld.admin.tm.registrar_data_details" %>
 ...
 <script type="text/javascript">
   ...
   function (isConfirm) {
       if (isConfirm) {
           ...
           window.location.assign("registrar.aspx");
...
<div>
    <div class="container">
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" 
                    RepeatDirection="Horizontal" 
                    onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    <asp:ListItem id="tt8" Value="Registered"  >Register</asp:ListItem>
                    <asp:ListItem Value="Deferred">Defer</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:TextBox Visible="false" ID="txt_rtm" runat="server" CssClass="textbox"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
           ...
           <%--  <ASPP:PopupPanel style="text-align:center;" HeaderText="RTM NO" Width="600px" Height="500px" ID="pup" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow Width="600px" ID="PopupWindow1" Height="500px"  runat="server">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="Label8" Width="400px" runat="server" Text="Label"></asp:Label>
