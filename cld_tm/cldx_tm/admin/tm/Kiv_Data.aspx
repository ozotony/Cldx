<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kiv_Data.aspx.cs" Inherits="cld.admin.tm.Kiv_Data" %>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}" >
              ...
              <%-- <a href="./g_application_details.aspx?x={{row.log_staff}}"><i class="fa fa-link"></i></a>--%>
                    <a href="./verify_data_details2.aspx?x={{row.xid}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="./verify_data_details2.aspx?x={{row.xid}}"> <i class="fa fa-external-link"></i></a>
            </td>
