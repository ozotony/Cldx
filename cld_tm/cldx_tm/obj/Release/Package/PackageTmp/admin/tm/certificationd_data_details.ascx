<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="certificationd_data_details.ascx.cs" Inherits="cld.admin.tm.certificationd_data_details" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="Defer">Deferred</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
