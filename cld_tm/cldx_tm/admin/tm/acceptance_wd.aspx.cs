...
{
    public partial class acceptance_wd : Page
    {
        public string admin = "0";
        public int back;
        public string criteria = "";
        public string criteria_type = "";
        public string data_status = "Withdraw";
        ...
        {
            base.Response.Redirect("acceptance_wd.aspx");
        }
        ...
        protected void gvX_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "TmViewClick")
            {
                ...
                base.Response.Redirect("acceptance_wd_details.aspx?x=" + str);
            }
        }
