<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="red.aspx.cs" Inherits="cld.admin.tm.acceptance_unit.red" %>
 ...
 <script type="text/javascript">
    ...
    <style type="text/css">
        .style1
        {
            ...
            width: 20%;
            height: 20px;
            background: url('../../../images/green_header.gif') repeat-x 50% top;
            text-align: center;
            color: #fff;
            font-weight: bold;
            border-radius: 10px;
