<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="registrar_c_data_details.cs" Inherits="cld.admin.tm.registrar_c_data_details" %>
                   ...
                   <%--  <tr>
                    ...
                    <tr>
                       ...
                       <td style="font-family: Garamond; font-size:16px; font-weight:bold; text-align:right;">
                         ...
                         <qrcode data={{string}} download> </qrcode> <img src="signatures/aisha_acceptance_mini_png4.png" style=" width: 222px;;height: 83px;vertical-align:bottom" />  <%-- <img src="signatures/Adeyemi.jpg" style=" width: 222px;;height: 83px;vertical-align:bottom" /> --%>
                               </div>
...
address, application should AT ONCE be made to the Registrar to register the change .
            ...
            <td align="center">
             <%--<input type="button" name="Printform" id="Printform" value="Print" onclick="printTm('cert'); return false" class="button" />--%>
                <input type="button" name="Printform" id="Printform" value="Print" ng-click="add()"  class="button no-print" />
            </td>
            </tr>
            </table>
