<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrard.aspx.cs" Inherits="cld.admin.tm.registrard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>REGISTRAR DEFERRED DATA</title>
   ...
   <div>
    <div class="container">
        ...
        <div class="content">
          ...
          <tr>
            <td colspan="8"  class="tbbg"> WELCOME TO THE REGISTRAR DEFERRED UNIT</td>
          </tr>
          <tr class="stripedout">
          ...
          <tr >
            <td style="text-align:center;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VIEW" >
                             <ItemTemplate>
                              <asp:HyperLink ID="btnnewTab" Text="New Tab" runat="server" Target="_blank" NavigateUrl='<%# string.Format("./registrard_data_detailsx.aspx?x={0}", Eval("xid")) %>' />
                             </ItemTemplate>
