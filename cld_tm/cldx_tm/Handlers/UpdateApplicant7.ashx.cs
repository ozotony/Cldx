...
{
    /// <summary>
    /// Summary description for UpdateApplicant7
    /// </summary>
    public class UpdateApplicant7 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string xk = ff.InsertRecordal55(dd.vv, dd.vv2, dd.vv3, dd.vv4, dd.vv5, dd.vv6, vfile2, vfile1);

            Recordal_Result xk2 = ff.InsertRecordal8(dd.vv13, dd.vv14, dd.vv15, xk, dd.vv16);
