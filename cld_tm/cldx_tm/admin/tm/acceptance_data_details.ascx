<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="acceptance_data_details.cs" Inherits="cld.admin.tm.acceptance_data_details"  %>
        ...
        <div class="content">
            <div class="header">
                <div class="xmenu">
                    <div class="menu">
                        <ul class='no-print'>
                            <li class='no-print'><a href="./lo.aspx">
