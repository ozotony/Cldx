<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="preview_r_data.ascx.cs" Inherits="cld.admin.tm.preview_r_data" %>
                    ...
                    <%if (lt_mi.Count > 0)
             {
                 ...
                 { %>
                    <tr>
                        ...
                        <td width="5%" align="center">
                            <a href="preview_r_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
                        </td>
                    </tr>
                    <% sn++; } 
             }%>
