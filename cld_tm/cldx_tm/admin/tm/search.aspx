<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="cld.admin.tm.search" %>
...
<body ng-controller="myController10">
   ...
   <div>
    <div class="container">
        <div class="sidebar">
            <a href="./search_unit/profile.aspx">PROFILE</a> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./search_unit_unit/sed.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
          ...
          <tr >
            <td style="text-align:center;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VIEW" >
                             <ItemTemplate>
                              <asp:HyperLink ID="btnnewTab" Text="New Tab" runat="server" Target="_blank" NavigateUrl='<%# string.Format("./s_data_details.aspx?x={0}", Eval("xid")) %>' />
                             </ItemTemplate>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" >
               ...
               <a target="_blank" class="icon-bar" href="./s_data_details_report.aspx?x={{row.xid}}&cri=n "> <i class="fa fa-external-link"></i></a>
                ...
                <td align="center">
               <a target="_blank" class="icon-bar" href="./s_data_details.aspx?x={{row.xid}}&cri=n "> <i class="fa fa-external-link"></i></a>
            </td>
...
<body ng-controller="myController4">
   ...
   <div>
    <div class="container">
        <div class="sidebar">
            <a href="./search_unit/profile.aspx">PROFILE</a>  <a href="./search_unit_unit/sed.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
            ...
            <tr ng-repeat="row in displayedCollection" >
                ...
                <td align="center">{{row.xclass}}</td>
                 ...
                 <td align="center">{{row.xstat}}</td>
                   ...
                   <td align="center">
               <a target="_blank" class="icon-bar" href="s_data_details_report.aspx?x= {{row.xid}} &cri=Report" > <i class="fa fa-external-link"></i></a>
            </td>
