...
{
    /// <summary>
    /// Summary description for Save_GenericApplication7
    /// </summary>
    public class Save_GenericApplication7 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Request.Files.Count > 0)
            {
              ...
              //  tt2.addxtest("inside");
                ...
                if (context.Request.Files["FileUpload"] != null)
                {
                  
                    fu_logo_pic = context.Request.Files["FileUpload"];
                ...
                if (context.Request.Files["FileUpload2"] != null)
                {
                    fu_app_doc = context.Request.Files["FileUpload2"];

                }

                if (context.Request.Files["FileUpload3"] != null)
                {
                    fu_cert_doc = context.Request.Files["FileUpload3"];

                }

                if (context.Request.Files["FileUpload4"] != null)
                {
                    fu_pub_doc = context.Request.Files["FileUpload4"];
    ...
    fu_logo_pic, fu_app_doc, fu_cert_doc, fu_pub_doc, serverpath);
            ...
            if (vt != null)
            {
                ...
                tt.updateHwallet(words[2], "Used", reg_date, dd.Title_Of_Trademark);
            }
