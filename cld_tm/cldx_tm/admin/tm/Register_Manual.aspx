<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register_Manual.aspx.cs" Inherits="cld.admin.tm.Register_Manual" %>
...
&nbsp;&nbsp;
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
                ...
                <td align="center">
               <a href="rGeneric_registrar_data_details3.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"><i class="fa fa-link"></i></a>
               
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="Generic_registrar_data_details3.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}}"> <i class="fa fa-external-link"></i></a>
            </td>
