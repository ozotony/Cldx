<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="preview_x_detailsx.ascx.cs" Inherits="cld.admin.tm.preview_x_detailsx" %>
            ...
            <div id="searchform">
                <table align="center" width="100%" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="Label"><% Response.Write("OAI/TM/" + t.ValidationIDByPwalletID(c_mark.log_staff)); %></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tbbg" colspan="2" align="center">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <img src="<% Response.Write(c_mark.logo_pic); %>" height="30%" width="30%" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
