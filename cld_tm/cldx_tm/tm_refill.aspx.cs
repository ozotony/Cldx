...
namespace cld
{
    public partial class tm_refill : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                xaid.Value = base.Request.QueryString["XXX94384238"].ToString();
                this.Session["aid"] = xaid.Value; this.xcode.Text = Request.QueryString["XXX94384238"].ToString();
            }
            else
            {
                // base.Response.Redirect("./appstatus.aspx");
        ...
        protected void SaveAll_Click(object sender, EventArgs e)
        {
            ...
            this.c_mark.logo_descriptionID = this.logo_description.SelectedValue; Session["logo_text"] = this.logo_description.SelectedValue;
