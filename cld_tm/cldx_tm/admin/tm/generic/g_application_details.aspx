<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_application_details.aspx.cs" Inherits="cld.admin.tm.generic.g_application_details" MaintainScrollPositionOnPostback="true" %>
        ...
        <table style="width:100%;font-family:Calibri;" id="applicantForm" align="center" class="form">
            ...
            <tr>
             ...
             <tr>
                ...
                <td width="50%" align="left" colspan="2">        
                    <b> <% =Session["vreg_no"].ToString()%></b></td>
