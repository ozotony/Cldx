<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registrar_Manual_Details.aspx.cs" Inherits="cld.admin.tm.Registrar_Manual_Details" %>
...
<body>
    ...
    <table align="center" width="1200px">
            <tr >
                <td >
    <div id="searchform">                
        <table style="font-family:Calibri;" id="applicantForm" align="center" class="xsearchform table-bordered ">
            <tr align="center">
                <td colspan="4">
            ...
            <tr>
             ...
             <tr>
                ...
                <td style="width: 25%;text-align:right;">TRANSACTION ID:</td>
                <td style="width: 25%;text-align:left;"> <%=g_pwallet.validationID%></td>
            </tr>     
     ...
     <table width="100%">
            ...
            <div style="float:left;width:100%;">
                <asp:DropDownList ID="DropDownList1" onselectedindexchanged="itemSelected"  AutoPostBack="true" runat="server">
                    <asp:ListItem>-Select Action-</asp:ListItem>
                    <asp:ListItem Value="8">Certified</asp:ListItem>
                    <asp:ListItem Value="4">Refused</asp:ListItem>
                    <asp:ListItem Value="5">Accepted</asp:ListItem>
                    <asp:ListItem Value="1">Fresh</asp:ListItem>
                    <asp:ListItem Value="3">Search Conducted</asp:ListItem>
                    <asp:ListItem Value="6">Opposed</asp:ListItem>
                    <asp:ListItem Value="6">Published</asp:ListItem>
                </asp:DropDownList>
                <asp:Button ID="Verify" Visible="false" runat="server" Text="Update" OnClick="Verify_Click" class="button" />
                <input type="button" name="Printform" id="Printform" value="Print" onclick="printGenericAdminGf('searchform');return false" class="button" />
