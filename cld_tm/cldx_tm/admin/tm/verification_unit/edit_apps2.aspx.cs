...
{
    using cld.Classes;
    public partial class edit_apps2 : System.Web.UI.Page
    {
            ...
            if (txt_search.Text != "")
            {
                try
                {
                    ...
                    if (Convert.ToInt32(c_id) > 0)
                    {
                        ...
                        if (c_pwall.data_status == "Fresh" || c_pwall.data_status == "Valid" || c_pwall.data_status == "Re-conduct search" || c_pwall.data_status == "Search Conducted" || c_pwall.data_status == "Search 2 Conducted" || c_pwall.data_status == "Re-examine" || c_pwall.data_status == "Registrable" || ( (c_pwall.data_status== "Kiv") && (Convert.ToInt32(c_pwall.status)==14)))
                        {
        ...
        protected void SaveAll_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(succ) > 0)
                {
                    ...
                    //   t.activity_log(this.adminID, "Edit Application", "Update", c_app.log_staff, c_pwall.data_status);
                    //}
                    //else
                    //{
                    //    scope.Dispose();
