namespace cld.admin.tm.acceptance_unit
{
    ...
    public class red : Page
    {
        ...
        protected void btnAll_Click(object sender, EventArgs e)
        {
            this.Session["f"] = "";
            this.Session["t"] = "";
            base.Response.Redirect("./red.aspx");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((this.fromdate != "") && (this.todate != ""))
            {
                ...
                this.g_utotal = this.z.getTotalEntriesByDate("8", this.fromdate, this.todate);
                this.g_new = this.z.getTotalEntryCountStageByDate("8", "Certified", this.fromdate, this.todate);
                this.g_treated = this.z.getTotalEntryCountStageByDate("8", "", this.fromdate, this.todate);
                this.g_rejected = this.z.getTotalEntryCountByStage("8", "Deferred");
            }
            else
            {
                this.g_total = this.z.getTotalEntries("");
                this.g_utotal = this.z.getTotalEntries("8");
                this.g_new = this.z.getTotalEntryCountByStage("8", "Certified");
                this.g_treated = this.z.getTotalEntryCountByStage("8", "");
                this.g_rejected = this.z.getTotalEntryCountByStage("8", "Deferred");
            }
