...
namespace cld.Handlers
{
    ...
    public class Save_GenericApplication : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int vt = tt.addGeneric2Tx(serverpath, c_pwall, g_app_info, g_applicant_info, g_tm_info, g_agent_info,
                  g_ass_info, g_merger_info, g_cert_info, g_change_info, g_renewal_info,
                 g_prelim_search_info, g_other_items_info, fu_logo_pic, fu_sup_doc, fu_app_doc, fu_merger_doc,
                  fu_ass_doc, fu_pub_doc, fu_cert_doc
                  );
