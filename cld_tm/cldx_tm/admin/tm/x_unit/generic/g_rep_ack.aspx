<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_rep_ack.aspx.cs" Inherits="cld.admin.tm.x_unit.generic.g_rep_ack" %>
    ...
    <div id="searchform">                
        <table style="font-family:Calibri;" id="applicantForm" align="center" class="xsearchform">
            ...
            <td align="left" colspan="2" >
                 <%= ret.getCountryName( g_ass_info.assignee_nationality) %>
                     </td>
            </tr>
            <tr>
                <td colspan="4" 
            ...
            <td align="left" colspan="2" >
                 <%= ret.getCountryName( g_ass_info.assignor_nationality)%>
                     </td>
            </tr>
            <tr>
