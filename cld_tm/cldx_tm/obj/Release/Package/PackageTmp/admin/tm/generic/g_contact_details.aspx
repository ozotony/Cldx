<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_contact_details.aspx.cs" Inherits="cld.admin.tm.generic.g_contact_details" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="container">
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Vertical"  Width="200px"
        ...
        <tr>
            <td class="tbbg" colspan="4" align="center">  --- ADD COMMENT --- er">  --- ADD COMMENT --- </td>
        </tr>
        <tr>
            <td align="center" colspan="4">
