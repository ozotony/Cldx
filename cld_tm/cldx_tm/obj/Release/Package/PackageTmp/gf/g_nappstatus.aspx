<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_nappstatus.aspx.cs" Inherits="cld.gf.g_nappstatus" %>
        ...
        <tr>
            ...
            <% if (showt == 1)
               ...
               <td align="center">
                ...
                <% if (refill == 0)
                   { %>
                        <input type="button" name="btnReprint" id="btnReprint" value="REPRINT ACKNOWLEDGEMENT FORM"  onclick="doView('./g_rep_ack.aspx?0001234445XXX43943OPFDSMZXUHSJFDSK88999DKGFSDKFSKFDKFD=<% Response.Write(Session["agt"].ToString()); %>&0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=<% Response.Write(g_pwallet.validationID); %>');" class="button" />
