<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="publish_apps_data_details.ascx.cs" Inherits="cld.admin.tm.publish_apps_data_details" %>
...
<div>
    <div class="container">
        <div class="sidebar">
            <a href="./publication_unit/profile.aspx">PROFILE</a> 
            <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> 
            <a href="./publication_unit/ped.aspx">VIEW STATISTICS</a>
    ...
    <table align="center" width="100%" class="form">
        ...
        <tr>
            <td width="22%" colspan="2" class="tbbg" align="center">
                <strong>DATA DETAILS FOR "<% Response.Write(lt_mi[0].product_title.ToUpper()); %>"</strong></td>
        </tr>
         <tr>
       ...
       <tr>
            ...
            <td>
                <asp:Label ID="Label6" runat="server" Text="Label"><% Response.Write(t.getTmTypeName(lt_mi[0].tm_typeID).ToUpper()); %></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:Label ID="Label27" runat="server" Text="Label"><% Response.Write(t.getLogoDescriptionName(lt_mi[0].logo_descriptionID).ToUpper()); %></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label28" runat="server" Text="Label"><% Response.Write(lt_mi[0].nice_class.ToUpper()); %></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
         ...
         <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <% Response.Write(lt_rep[0].agent_code.ToUpper()); %>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td> <% 
                           //  string addID = t.getAddressByID(lt_rep[0].addressID)[0].countryID;
             Response.Write(t.getCountryName(t.getAddressByID(lt_rep[0].addressID)[0].countryID).ToUpper()); %></td>
                </tr>
                <tr>
                    <td align="right">
                        STATE:
                    </td>
                    <td> <% Response.Write(t.getStateName(t.getAddressByID(lt_rep[0].addressID)[0].stateID).ToUpper()); %></td>
                </tr>
                <tr>
                    <td align="right">
                        CITY :
                    ...
                    <td> <%
                             ;
                             Response.Write(t.getAddressByID(lt_rep[0].addressID)[0].city.ToUpper()); %></td>
                </tr>
                <tr>
                    <td align="right">
                        STREET :
                    </td>
                    <td> <% Response.Write(t.getAddressByID(lt_rep[0].addressID)[0].street.ToUpper()); %></td>
                </tr>
                <tr>
                    <td align="right">
                        ZIP:
                    </td>
                    <td> <% Response.Write(t.getAddressByID(lt_rep[0].addressID)[0].zip.ToUpper()); %></td>
                </tr>
                <tr>
                    <td align="right">
                        TELEPHONE:</td>
                    <td> <% Response.Write(t.getAddressByID(lt_rep[0].addressID)[0].telephone1.ToUpper()); %></td>
                </tr>
                <tr>
                    <td align="right">
                        &nbsp;E-MAIL:</td>
                    <td> <% Response.Write(t.getAddressByID(lt_rep[0].addressID)[0].email1.ToUpper()); %></td>
                </tr>
        <tr>
            <td class="tbbg" colspan="2" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <% Response.Write(lt_p[0].validationID); %>
                    </td>
                </tr>
                <tr>
                    <td align="right">
