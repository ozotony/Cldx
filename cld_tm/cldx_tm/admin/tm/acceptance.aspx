<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="acceptance.aspx.cs" Inherits="cld.admin.tm.acceptance" %>
            ...
            <td style="text-align:center;" >
                <asp:GridView ID="gvX" runat="server" AllowPaging="True" AutoGenerateColumns="False" CaptionAlign="Left" CellPadding="4" EnableModelValidation="True" ForeColor="#000000" GridLines="Both" HorizontalAlign="Left" onrowcommand="gvX_RowCommand"   onpageindexchanging="gvX_PageIndexChanging"    style="margin-top: 0px; width:100%; font-size:12px;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VIEW" >
                             <ItemTemplate>
                              <asp:HyperLink ID="btnnewTab" Text="New Tab" runat="server" Target="_blank" NavigateUrl='<%# string.Format("./acceptance_data_detailsx.aspx?x={0}", Eval("xid")) %>' />
                             </ItemTemplate>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" >
               ...
               <a target="_blank" class="icon-bar" href="./s_data_details_report.aspx?x={{row.xid}}&cri=n "> <i class="fa fa-external-link"></i></a>
                ...
                <td align="center">
               <a href="./acceptance_data_detailsx.aspx?x={{row.xid}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="./acceptance_data_detailsx.aspx?x={{row.xid}}"> <i class="fa fa-external-link"></i></a>
            </td>
