...
{
    public partial class registrar_Manual_details2 : System.Web.UI.Page
    {
        ...
        protected void Verify_Click(object sender, EventArgs e)
        {
            ...
            this.succ = this.z.a_tm_office(this.admin, "Migrated", this.DropDownList1.SelectedValue, "", "", "", "", this.admin);
            if (this.succ != "0")
            {
