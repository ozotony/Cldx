<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="c_index.aspx.cs" Inherits="cld.c_index" %>
...
// <![CDATA[
        ...
        //alert(" <% Response.Write(xapplication); %> ");
        function Proceed_onclick() {
            window.location.href = "./c_trademark.aspx";
