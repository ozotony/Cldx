<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="opposed_data_details.ascx.cs"
    Inherits="cld.admin.tm.opposed_data_details" %>
...
<div>
    <div class="container">
        <div class="sidebar">
            ...
            <a href="./opposition_unit/profile.aspx">VIEW OPPOSED APPS</a>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" 
                    ...
                    <asp:ListItem Value="Not Opposed">Cleared</asp:ListItem>
                    <asp:ListItem Value="Opposed" >Not Cleared</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
