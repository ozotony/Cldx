<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_Recordal3.aspx.cs" Inherits="cld.admin.tm.g_Recordal3" %>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
               ...
               <td align="center">{{row.RECORDAL_TYPE2}}</td>
                ...
                <td align="center">
               <a href="Generic_registrar_data_details7.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}} &&recordalid={{row.RecordalID}}"><i class="fa fa-link"></i></a>
                
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="Generic_registrar_data_details7.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}} &&recordalid={{row.RecordalID}}"> <i class="fa fa-external-link"></i></a>
            </td>
