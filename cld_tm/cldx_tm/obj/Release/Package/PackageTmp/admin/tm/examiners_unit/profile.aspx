<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.cs" Inherits="cld.admin.tm.examiners_unit.profile" %>
    ...
    <table align="center" width="100%" >
        <tr>
            <td colspan="3" align="left" class="tbbg">
                WELCOME TO THE EXAMINERS UNIT</td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 30%;" align="center">
                <a href="./examiners_profile.aspx">VIEW APPLICATIONS</a></td>
            <td style="width: 30%;" align="center">
