namespace cld.admin.tm.acceptance_unit
{
    ...
    public class ped : Page
    {
        ...
        protected void btnAll_Click(object sender, EventArgs e)
        {
            this.Session["f"] = "";
            this.Session["t"] = "";
            base.Response.Redirect("./ped.aspx");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((this.fromdate != "") && (this.todate != ""))
            {
                ...
                this.g_utotal = this.z.getTotalEntriesByDate("5", this.fromdate, this.todate);
                this.g_new = this.z.getTotalEntryCountStageByDate("5", "Accepted", this.fromdate, this.todate);
                this.g_treated = this.z.getTotalEntryCountStageByDate("5", "", this.fromdate, this.todate);
                this.g_rejected = this.z.getTotalEntryCountByStage("5", "Defered");
            }
            else
            {
                this.g_total = this.z.getTotalEntries("");
                this.g_utotal = this.z.getTotalEntries("5");
                this.g_new = this.z.getTotalEntryCountByStage("5", "Accepted");
                this.g_treated = this.z.getTotalEntryCountByStage("5", "");
                this.g_rejected = this.z.getTotalEntryCountByStage("5", "Defered");
            }
