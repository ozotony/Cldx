<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_details7.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_details7" %>
    ...
    <form id="form1" runat="server">
     <div class="container">
       <div class="sidebar no-print">
            <a href="./opposition_unit/profile.aspx">PROFILE</a> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./opposition_unit/oed.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
 ...
 <% Response.Write(xhistory); %>  
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="true">
                    <asp:ListItem Value="Update" >Update Recordal</asp:ListItem>
