...
{
    public partial class g_treated : Page
    {
        ...
        protected void gvX_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "TmViewClick")
            {
                ...
                base.Response.Redirect("g_treated_details.aspx?x=" + str);
            }
        }
        ...
        private void PopulateData(int pageNo, int noOfRecord)
        {
            ...
            pz = z.getNew_RowCount10(this.x_status, this.x_data_status);
            ...
            if ((this.Session["pwalletID"] != null) && (this.Session["pwalletID"].ToString() != ""))
            {
                ...
                if (!base.IsPostBack)
                {
                 ...
                 //   this.lt_m = this.z.getGAppInfoRSX(this.x_status, this.x_data_status, "0", this.max.ToString());
                    ...
                    int kk = z.getNew_RowCount10(this.x_status, this.x_data_status).Count();
                    ...
                    ViewState["TotalRecord"] = (z.getNew_RowCount10(this.x_status, this.x_data_status)).Count;// GetTotalCount();
