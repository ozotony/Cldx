<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_Recordal4b.aspx.cs" Inherits="cld.admin.tm.g_Recordal4b" %>
...
<body ng-controller="myController9b">
   ...
   <div>
    <div class="container">
        ...
        <table class="table-bordered"  >
            ...
            <tr>
                <td>
                     <table width="100%" border="0" cellspacing="1" cellpadding="4" class="table table-fixed" align="center">
                                        <thead>
                                            <tr>
...
&nbsp;&nbsp;
        ...
        <thead>
            ...
            <th  st-sort="RECORDAL_STATUS" class="tbbg2">RECORDAL STATUS</th>
                 ...
                 <th  st-sort="getters.registrationDate"   class="tbbg2">APPROVAL  DATE</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
               ...
               <td  align="center">{{row.RECORDAL_TYPE2}}</td>
                ...
                <td  align="center">
               <a href="Generic_registrar_data_details6.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}} &&recordalid={{row.RecordalID}}"><i class="fa fa-link"></i></a>
                
            </td>

                 <td  align="center">
               
               <a target="_blank" class="icon-bar" href="Generic_registrar_data_details6.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD={{row.oai_no}} &&recordalid={{row.RecordalID}}"> <i class="fa fa-external-link"></i></a>
            </td>
