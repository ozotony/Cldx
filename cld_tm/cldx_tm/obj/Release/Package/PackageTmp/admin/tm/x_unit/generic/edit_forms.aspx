<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_forms.aspx.cs" Inherits="cld.admin.tm.x_unit.generic.edit_forms" MaintainScrollPositionOnPostback="true"%>
...
<body>
  ...
  <table style="width:100%;font-family:Calibri;" id="applicantForm" align="center" >
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_applicant_mobile" runat="server" class="textbox" 
                        Width="400px"></asp:TextBox>
                </td>
            </tr>
             <tr>
            ...
            <td>
              &nbsp;TELEPHONE: &nbsp;</td>
            <td >
            <asp:TextBox ID="txt_rep_telephone" runat="server" Width="400px" CssClass="textbox"></asp:TextBox>
                </td>
            </tr>
            <tr>
            <td>
            ...
            <td >
            <asp:TextBox ID="txt_rep_email" runat="server" Width="400px" CssClass="textbox"></asp:TextBox>
                   </td>
            </tr>
            <% if (cert_show > 0)
               { %>
            ...
            <tr>
                ...
                <td align="left">            
                    New Date:<br />
            <asp:TextBox ID="txt_new_date" runat="server" Width="200px" CssClass="textbox" ></asp:TextBox></td>
            </tr>           
            <tr>
                <td colspan="2" align="center">
            
                 <asp:Button ID="SaveEdit" runat="server" Text="Edit Application"  class="button" onclick="SaveEdit_Click" 
                  />
                </td>
            </tr>           
            </table>
