<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_ipo_rep_ack.aspx.cs" Inherits="cld.gf.g_ipo_rep_ack"  MaintainScrollPositionOnPostback="true"%>
...
<body>
    ...
    <table  style="width:1200px; text-align:center;">
     ...
     <tr style="width:100%;text-align:center;">
                <td >
                 <input type="button" name="Printform" id="Printform" value="Print" onclick="printGf('xsearchform');return false" class="button" />&nbsp;
