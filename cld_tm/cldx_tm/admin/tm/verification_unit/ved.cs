namespace cld.admin.tm.acceptance_unit
{
    ...
    public class ved : Page
    {
        ...
        protected void btnAll_Click(object sender, EventArgs e)
        {
            this.Session["f"] = "";
            this.Session["t"] = "";
            base.Response.Redirect("./ved.aspx");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((this.fromdate != "") && (this.todate != ""))
            {
                ...
                this.g_utotal = this.z.getTotalEntriesByDate("1", this.fromdate, this.todate);
                this.g_new = this.z.getTotalEntryCountStageByDate("1", "Fresh", this.fromdate, this.todate);
                this.g_treated = this.z.getTotalEntryCountStageByDate("1", "", this.fromdate, this.todate);
                this.g_rejected = this.z.getTotalEntryCountByStage("1", "Invalid");
            }
            else
            {
                this.g_total = this.z.getTotalEntries("");
                this.g_utotal = this.z.getTotalEntries("1");
                this.g_new = this.z.getTotalEntryCountByStage("1", "Fresh");
                this.g_treated = this.z.getTotalEntryCountByStage("1", "");
                this.g_rejected = this.z.getTotalEntryCountByStage("1", "Invalid");
            }
