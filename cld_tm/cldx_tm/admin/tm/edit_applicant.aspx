<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_applicant.cs" Inherits="cld.admin.tm.edit_applicant" %>
    ...
    <div class="container">
        ...
        <tr>
            <td width="30%">
                &nbsp;</td>
            <td>
                <asp:Button ID="SearchApplicant" runat="server" Text="Search For Applicant" 
