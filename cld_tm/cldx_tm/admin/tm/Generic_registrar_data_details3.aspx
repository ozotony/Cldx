<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generic_registrar_data_details3.aspx.cs" Inherits="cld.admin.tm.Generic_registrar_data_details3" %>
            ...
            <td align="center" colspan="4">   
                <% if (g_tm_info.logo_pic != "")
               {
                 //  Response.Write("<a href=" + "../tm/gf/" + g_tm_info.logo_pic + " target='_blank'>View</a>");    
                     Response.Write("<a href=" + "../tm/" + g_tm_info.logo_pic + " target='_blank'>View</a>");    
            ...
            <td align="center" colspan="4">   
                <% if (g_tm_info.app_letter_doc != "")
               {
                 //  Response.Write("<a href=" + "../tm/gf/" + g_tm_info.app_letter_doc + " target='_blank'>View</a>");    
                    Response.Write("<a href=" + "../tm/" + g_tm_info.app_letter_doc + " target='_blank'>View</a>");    
         }  else { Response.Write("NONE"); 
