<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="searcho.cs" Inherits="cld.admin.tm.searcho" %>
            ...
            <td colspan="8" align="center" class="tbbg">WELCOME TO THE SEARCH UNIT (PLEASE 
                ...
                <tr>
                    <td colspan="8" align="center" class="tbbg">
                        &nbsp;&nbsp; 
                        CLASS :
                        &nbsp;&nbsp;<asp:DropDownList ID="selectSearchCriteria" Enabled="false" runat="server" AutoPostBack="False">
                </asp:DropDownList>
