...
{
    public partial class Generic_registrar_data_details4bb : System.Web.UI.Page
    {
                ...
                if ((vid != null))
                {
                    ...
                    foreach (var ddp in vd)
                    {
                        ...
                        if (ddp.RECORDAL_TYPE == "registered_user")
                        {
                            ...
                            xusr6 = "GRANTEE  ADDRESS";

                            xusr7 = ddp.OLD_APPLICANTADDRESS;
                            xusr8 = ddp.NEW_APPLICANTADDRESS;
                            gen_nameHis2(ddp);
                        ...
                        {
                            Px = ddp;
                            Px.RECORDAL_TYPE = "FORM 19";
                            xusr = "OLD APPLICANT ADDRESS";
                            xusr2 = "NEW APPLICANT ADDRESS";
                            xusr3 = ddp.OLD_APPLICANTADDRESS;
                            xusr4 = ddp.NEW_APPLICANTADDRESS;
                            gen_nameAddress(ddp);
                        }
