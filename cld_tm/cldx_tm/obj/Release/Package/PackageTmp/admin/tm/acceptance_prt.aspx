<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="acceptance_prt.aspx.cs" Inherits="cld.admin.tm.acceptance_prt" %>
...
<link href="../../css/bootstrap.min.css" rel="stylesheet" />
    ...
    <script  type="text/javascript" src="../../Scripts/GetData3.js"></script>
            ...
            <td style="text-align:center;" >
                <asp:GridView ID="gvX" runat="server" AllowPaging="True" AutoGenerateColumns="False" CaptionAlign="Left" CellPadding="4" EnableModelValidation="True" ForeColor="#000000" GridLines="Both" HorizontalAlign="Left" onrowcommand="gvX_RowCommand"   onpageindexchanging="gvX_PageIndexChanging"    style="margin-top: 0px; width:100%; font-size:12px;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VIEW" >
                             <ItemTemplate>
                              <asp:HyperLink ID="btnnewTab" Text="New Tab" runat="server" Target="_blank" NavigateUrl='<%# string.Format("./acceptance_prt_details.aspx?x={0}", Eval("xid")) %>' />
                             </ItemTemplate>
        ...
        <thead>
            <tr>
               ...
               <th  class="tbbg2">View </th>
                 ...
                 <th  class="tbbg2">View New Window </th>
            ...
            <tr dir-paginate="row in ListAgent2|itemsPerPage:itemsPerPage" total-items="total_count"  ng-class="{'pending-delete': add2(row)}" >
                ...
                <td align="center">{{row.xclass}}</td>
                 ...
                 <td align="center">{{row.xstat}}</td>
                  ...
                  <td align="center">
               <a target="_blank"  href="./acceptance_prt_details.aspx?x={{row.xid}}&cri=n "> <i class="fa fa-external-link"></i>View</a>
            </td>
