<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrar_issue.aspx.cs" Inherits="cld.admin.tm.registrar_issue" %>
    ...
    <div class="container">
       ...
       <tr>
        ...
        <tr>
            ...
            <asp:Button ID="VAcpt" runat="server" Text="View Acceptance"  class="button" 
                    onclick="VAcpt_Click" />
                 &nbsp;
            <asp:Button ID="VAck" runat="server" Text="View Acknowledgement"  class="button" 
                    onclick="VAck_Click" />
                &nbsp;
            <asp:Button ID="VCert" runat="server" Text="View Certificate"  class="button" 
                    onclick="VCert_Click" />
