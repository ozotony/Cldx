<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newinhousetrans.aspx.cs" Inherits="cld.admin.tm.x_unit.newinhousetrans" %>
    ...
    <table align="center" width="100%" class="form">
        ...
        <tr>
            ...
            <asp:TextBox ID="xamt" runat="server" Width="300px" CssClass="textbox"></asp:TextBox>
                * (Please enter the amount without commas! Eg=15000</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="tbbg" colspan="2">                
                <asp:Button ID="Save" runat="server" Text="Add"  class="button"  onclick="Save_Click"/>
            </td>
        </tr>
    </table>
        </div>
